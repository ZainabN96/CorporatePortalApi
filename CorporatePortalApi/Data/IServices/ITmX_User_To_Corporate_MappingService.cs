...
namespace CorporatePortalApi.Data.IServices
{
    public interface ITmX_User_To_Corporate_MappingService
    {
        ...
        Task<TmX_User_To_Corporate_Mapping> GetWithUser_Id(Guid userId);
        ...
        Task<bool> IsTmX_User_To_Corporate_MappingExist(int userMappingId, Guid userId, int corporateId);
        Task<bool> IsTmX_User_To_Corporate_MappingExistInUpdate(int userMappingId, Guid userId, int corporateId);
